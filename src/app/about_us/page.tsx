...
export default function AboutUsPage() {
  return (
    <div className="relative min-h-screen w-full overflow-hidden pb-24 pt-10">
      <div className="pointer-events-none absolute left-1/2 top-[5%] z-0 h-[600px] w-[600px] -translate-x-1/2 rounded-full bg-[#EC5800] opacity-[0.04] blur-[120px]" />
      <div className="pointer-events-none absolute -left-[10%] top-[20%] z-0 h-[400px] w-[400px] rounded-full bg-[#FFDEBA] opacity-[0.02] blur-[100px]" />
      <div className="pointer-events-none absolute -right-[10%] top-[60%] z-0 h-[500px] w-[500px] rounded-full bg-[#EC5800] opacity-[0.03] blur-[150px]" />
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {[
            ...
            <motion.div 
              ...
              className="group flex flex-col items-start rounded-[24px] border border-transparent border-t-[#ffffff1a] bg-[rgba(255,255,255,0.02)] p-8 backdrop-blur-md shadow-[0_15px_30px_rgba(0,0,0,0.3)] transition-all duration-300 hover:-translate-y-2 hover:bg-[rgba(255,255,255,0.04)] hover:shadow-[0_25px_50px_rgba(0,0,0,0.5)]"
            >
              <div className="mb-6 flex h-14 w-14 items-center justify-center rounded-full bg-[#EC5800]/10 text-[#EC5800] border border-[#EC5800]/20 transition-all duration-300 group-hover:scale-110 group-hover:bg-[#EC5800]/20 group-hover:shadow-[0_0_20px_rgba(236,88,0,0.15)]">
                {feature.icon}
              </div>
      ...
      >
        ...
        <div className="grid gap-6 md:grid-cols-3">
          {[
            ...
            <motion.div key={idx} variants={itemVariants} className="relative overflow-hidden rounded-[20px] bg-[rgba(30,26,30,0.4)] p-6 border border-[#ffffff0a] backdrop-blur-sm">
              <div className="absolute top-0 left-0 w-1 h-full bg-gradient-to-b from-[#EC5800] to-transparent opacity-50" />
        ...
        <div className="flex flex-wrap justify-center gap-6">
          {[
            ...
            <motion.div 
              key={idx} 
              variants={itemVariants} 
              className="group relative flex w-full sm:w-[calc(50%-12px)] md:w-[calc(33.333%-16px)] lg:w-[calc(25%-18px)] max-w-[260px] flex-col items-center rounded-[24px] border border-transparent border-t-[#ffffff1a] bg-[rgba(255,255,255,0.02)] p-6 text-center backdrop-blur-md transition-all duration-300 hover:-translate-y-2 hover:bg-[rgba(255,255,255,0.05)] hover:shadow-[0_15px_30px_rgba(0,0,0,0.4)]"
            >
              <div className="mb-4 h-20 w-20 overflow-hidden rounded-full border-2 border-[#ffffff10] bg-[#1a171a] p-1 transition-transform duration-300 group-hover:border-[#EC5800]/50 group-hover:scale-105">
      ...
      >
        <motion.div 
          variants={itemVariants} 
          className="relative flex flex-col items-center overflow-hidden rounded-[32px] border border-transparent border-t-[#ffffff1a] bg-[rgba(255,255,255,0.02)] p-10 text-center backdrop-blur-md shadow-[0_15px_30px_rgba(0,0,0,0.3)] md:p-16"
        >
          <div className="pointer-events-none absolute bottom-0 left-1/2 z-0 h-[200px] w-[300px] -translate-x-1/2 translate-y-1/2 rounded-full bg-[#EC5800] opacity-[0.15] blur-[80px]" />
          
          <div className="relative z-10">
            <h2 className="text-3xl font-black text-[#FFDEBA] md:text-4xl">Stop searching. Start saving.</h2>
            ...
            <Link 
              href="/" 
              className="group relative mt-8 mx-auto flex h-[50px] w-full max-w-[280px] items-center justify-center overflow-hidden rounded-full bg-[#EC5800] text-[14px] font-black tracking-[0.1em] text-[#FFDEBA] shadow-[0_8px_20px_rgba(236,88,0,0.3)] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_15px_35px_rgba(236,88,0,0.5)] active:scale-95"
            >
