        ...
        <div className="flex gap-3 rounded-2xl bg-[#1f1a1f] p-1.5 border border-white/5 shadow-inner">
          <button
            ...
            className={cn(
              ...
              state.activeTab === "products" ? "bg-[#EC5800] text-white shadow-[0_4px_15px_rgba(236,88,0,0.4)]" : "text-[#FFDEBA]/60 hover:text-white hover:bg-white/5"
            )}
          >
            All Products
          </button>
          <button
            ...
            className={cn(
              "rounded-xl px-8 py-3.5 text-sm font-bold transition-all duration-300",
              state.activeTab === "recipes" ? "bg-[#EC5800] text-white shadow-[0_4px_15px_rgba(236,88,0,0.4)]" : "text-[#FFDEBA]/60 hover:text-white hover:bg-white/5"
            )}
          >
            All Recipes
          </button>
        ...
        {state.currentCats.map((cat) => (
          <button
            ...
            className={cn(
              ...
              state.activeCategory === cat.id ? "bg-white/10 border-white/20 text-white shadow-sm" : "bg-transparent border-white/5 text-[#FFDEBA]/50 hover:bg-white/5 hover:text-white"
            )}
          >
            {cat.label}
          </button>
      ...
      <section className="w-full max-w-[1600px] mx-auto">
        ...
        <div className="mb-10 flex items-center justify-between px-2">
          <h2 className="text-2xl font-bold text-white">
            {state.activeCategory === "all" ? (state.activeTab === "products" ? "All Available Products" : "All Curated Recipes") : state.currentCatLabel}
          </h2>
        ...
        {state.visibleCount < state.itemsOnThisPage.length && (
