/**
 * @file layout.tsx
 * @brief Dashboard layout with premium glassmorphism, gradient borders, and light leaks.
 */
...
export default function ProfileLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="relative mx-auto flex min-h-[calc(100vh-85px)] w-full max-w-[1440px] gap-8 p-6 md:p-8 xl:p-10">
