/**
 * @file page.tsx
 * @brief Dashboard Overview page featuring gamified stats, background depth, profile completion, and recent activity.
 */
  ...
  return (
    <div className="relative flex flex-col gap-10 w-full pb-10">
      ...
      <div className="pointer-events-none absolute inset-0 -z-10 overflow-hidden rounded-[40px]">
        ...
        <div className="absolute -left-[10%] -top-[10%] h-[500px] w-[500px] rounded-full bg-[#EC5800]/5 blur-[120px]" />
      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="flex flex-col gap-2 max-w-md mt-2">
          ...
          <div className="h-2 w-full rounded-full bg-[rgba(50,45,50,0.4)] overflow-hidden shadow-inner">
            <motion.div 
              initial={{ width: 0 }} 
              animate={{ width: "80%" }} 
              transition={{ duration: 1.5, ease: "easeOut" }} 
              className="h-full bg-gradient-to-r from-[#EC5800] to-[#ff7e33] rounded-full"
            />
          </div>
      ...
      <div className="flex flex-col gap-4 z-10">
        <h3 className="text-[20px] font-bold tracking-[1px] text-[#FFDEBA]/90 pl-1 font-serif cursor-default select-none">
          Your Impact
        </h3>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          
          <div className="group flex flex-col justify-between rounded-[32px] bg-[rgba(50,45,50,0.3)] border border-[#FFDEBA]/5 p-7 backdrop-blur-[10px] shadow-[0_15px_35px_rgba(0,0,0,0.2)] transition-all duration-500 hover:bg-[rgba(70,59,70,0.35)] hover:-translate-y-1">
          ...
          <div className="group flex flex-col justify-between rounded-[32px] bg-[rgba(50,45,50,0.3)] border border-[#FFDEBA]/5 p-7 backdrop-blur-[10px] shadow-[0_15px_35px_rgba(0,0,0,0.2)] transition-all duration-500 hover:bg-[rgba(70,59,70,0.35)] hover:-translate-y-1">
            ...
            <div className="mt-4 flex flex-col cursor-default select-none">
              <span className="text-[42px] font-black text-[#FFDEBA] leading-none tracking-tight">
          ...
          <div className="group flex flex-col justify-between rounded-[32px] bg-[rgba(50,45,50,0.3)] border border-[#FFDEBA]/5 p-7 backdrop-blur-[10px] shadow-[0_15px_35px_rgba(0,0,0,0.2)] transition-all duration-500 hover:bg-[rgba(70,59,70,0.35)] hover:-translate-y-1 relative overflow-hidden">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 z-10">
        ...
        <div className="flex flex-col gap-4">
          <div className="flex justify-between items-end pl-1 pr-2">
            <h3 className="text-[20px] font-bold tracking-[1px] text-[#FFDEBA]/90 font-serif cursor-default select-none">Recent Baskets</h3>
            <button className="text-[12px] font-bold text-[#EC5800] uppercase tracking-wide hover:text-white transition-colors">View All</button>
          </div>
          <div className="group flex flex-col justify-between rounded-[36px] bg-[rgba(50,45,50,0.3)] border border-[#FFDEBA]/5 p-8 backdrop-blur-[10px] shadow-[0_15px_35px_rgba(0,0,0,0.2)] transition-all duration-500 hover:bg-[rgba(70,59,70,0.35)] relative overflow-hidden cursor-pointer h-full">
        ...
        <div className="flex flex-col gap-4">
          <div className="flex justify-between items-end pl-1 pr-2">
            <div className="flex items-center gap-3 cursor-default select-none">
              ...
              {/* Last Sync Timestamp */}
              <span className="flex items-center gap-1.5 rounded-full bg-[rgba(255,222,186,0.05)] px-2.5 py-1 text-[10px] text-[#FFDEBA]/40 font-medium">
          ...
          <div className="flex h-full flex-col justify-center rounded-[36px] bg-[rgba(50,45,50,0.3)] border border-[#FFDEBA]/5 p-8 backdrop-blur-[10px] shadow-[0_15px_35px_rgba(0,0,0,0.2)]">
            <div className="flex items-center justify-between border-b border-[#FFDEBA]/10 pb-5">
              ...
              <div className="w-[60px] h-[30px] opacity-80 pointer-events-none">
            ...
            <div className="flex items-center justify-between pt-5">
              ...
              <div className="flex h-8 px-3 items-center justify-center rounded-lg bg-green-500/20 text-green-400 text-[11px] font-bold border border-green-500/30 cursor-default select-none">
                Reached!
              </div>
            </div>
          </div>
