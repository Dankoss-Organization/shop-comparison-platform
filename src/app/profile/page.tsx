  ...
  return (
    <div className="relative flex flex-col gap-10 w-full pb-10">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center gap-6 md:gap-8 relative">
          ...
          <div className="flex flex-col gap-2.5 w-full">
            <div className="flex flex-wrap items-center gap-4">
              <h2 className="text-[36px] font-bold tracking-[1px] text-text-primary leading-none font-serif drop-shadow-md">
                {displayName}
              </h2>
            ...
            <p className="text-[16px] font-medium text-text-primary/50 tracking-wide cursor-default select-none">{email}</p>
          </div>
        </div>

        <div className="flex flex-col gap-2 max-w-md mt-2">
          <div className="flex justify-between items-end">
            <span className="text-[12px] font-bold uppercase tracking-[1px] text-text-primary/60">Profile Setup</span>
          ...
          <span className="text-[11px] text-text-primary/40 cursor-default select-none">
      ...
      <div className="flex flex-col gap-4 z-10">
        <h3 className="text-[20px] font-bold tracking-[1px] text-text-primary/90 pl-1 font-serif cursor-default select-none drop-shadow-md">
          Your Impact
        </h3>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          <div className="group flex flex-col justify-between rounded-[32px] bg-[linear-gradient(135deg,rgba(55,50,55,0.15),rgba(30,26,30,0.15))] backdrop-blur-[20px] shadow-[inset_0_1px_0_rgba(255,222,186,0.05),_0_15px_35px_rgba(0,0,0,0.3)] p-7 transition-all duration-500 hover:shadow-[inset_0_1px_0_rgba(255,222,186,0.15),_0_20px_45px_rgba(0,0,0,0.5)] hover:-translate-y-1">
            <span className="text-[13px] font-bold text-text-primary/50 uppercase tracking-[1.5px] cursor-default select-none">Total Savings</span>
          ...
          <div className="group flex flex-col justify-between rounded-[32px] bg-[linear-gradient(135deg,rgba(55,50,55,0.15),rgba(30,26,30,0.15))] backdrop-blur-[20px] shadow-[inset_0_1px_0_rgba(255,222,186,0.05),_0_15px_35px_rgba(0,0,0,0.3)] p-7 transition-all duration-500 hover:shadow-[inset_0_1px_0_rgba(255,222,186,0.15),_0_20px_45px_rgba(0,0,0,0.5)] hover:-translate-y-1">
            <span className="text-[13px] font-bold text-text-primary/50 uppercase tracking-[1.5px] cursor-default select-none">Active Alerts</span>
            <div className="mt-4 flex flex-col cursor-default select-none">
              <span className="text-[42px] font-black text-text-primary leading-none tracking-tight drop-shadow-md">
                <Counter from={0} to={2} duration={1} />
              </span>
              <span className="text-[12px] font-medium text-text-primary/40 mt-2">
          ...
          <div className="group relative flex flex-col justify-between overflow-hidden rounded-[32px] bg-[linear-gradient(135deg,rgba(55,50,55,0.15),rgba(30,26,30,0.15))] backdrop-blur-[20px] shadow-[inset_0_1px_0_rgba(255,222,186,0.05),_0_15px_35px_rgba(0,0,0,0.3)] p-7 transition-all duration-500 hover:shadow-[inset_0_1px_0_rgba(255,222,186,0.15),_0_20px_45px_rgba(0,0,0,0.5)] hover:-translate-y-1">
            <div className="relative z-10 flex flex-col cursor-default select-none">
              <span className="text-[13px] font-bold text-text-primary/50 uppercase tracking-[1.5px]">Top Store</span>
              <span className="mt-4 text-[32px] font-black text-text-primary leading-none tracking-tight drop-shadow-md">Сільпо</span>
              <span className="text-[12px] font-medium text-text-primary/40 mt-3">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 z-10">
        <div className="flex flex-col gap-4">
          <div className="flex justify-between items-end pl-1 pr-2">
            <h3 className="text-[20px] font-bold tracking-[1px] text-text-primary/90 font-serif cursor-default select-none drop-shadow-md">Recent Baskets</h3>
          ...
          <div className="group relative flex h-full flex-col justify-between overflow-hidden rounded-[36px] bg-[linear-gradient(135deg,rgba(55,50,55,0.15),rgba(30,26,30,0.15))] backdrop-blur-[20px] shadow-[inset_0_1px_0_rgba(255,222,186,0.05),_0_20px_40px_rgba(0,0,0,0.4)] p-8 transition-all duration-500 hover:shadow-[inset_0_1px_0_rgba(255,222,186,0.15),_0_25px_50px_rgba(0,0,0,0.6)] cursor-pointer">
            <div className="relative z-10 flex flex-col gap-6 h-full justify-between">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex flex-col">
                      <span className="text-[15px] font-bold text-text-primary drop-shadow-sm">Weekend BBQ Cart</span>
                      <span className="text-[12px] text-text-primary/50">Saved 2 days ago</span>
                    </div>
                  </div>
              ...
              <div className="flex flex-col gap-3">
                <span className="text-[12px] font-bold uppercase tracking-[1px] text-text-primary/40">Optimized across:</span>
                <div className="flex items-center gap-3">
                  <div className="flex h-12 w-20 items-center justify-center rounded-xl bg-[rgba(30,26,30,0.6)] border border-[#FFDEBA]/10 text-[11px] font-bold text-text-primary/70 shadow-[inset_0_2px_4px_rgba(0,0,0,0.3)]">Сільпо</div>
                  <div className="flex h-12 w-20 items-center justify-center rounded-xl bg-[rgba(30,26,30,0.6)] border border-[#FFDEBA]/10 text-[11px] font-bold text-text-primary/70 shadow-[inset_0_2px_4px_rgba(0,0,0,0.3)]">NOVUS</div>
                  <div className="flex h-8 w-8 items-center justify-center rounded-full bg-[rgba(30,26,30,0.4)] text-[11px] font-bold text-text-primary/50 border border-[#FFDEBA]/5">+2</div>
                </div>
              </div>
            </div>
        ...
        <div className="flex flex-col gap-4">
          <div className="flex justify-between items-end pl-1 pr-2">
            <div className="flex items-center gap-3 cursor-default select-none">
              <h3 className="text-[20px] font-bold tracking-[1px] text-text-primary/90 font-serif drop-shadow-md">Price Alerts Feed</h3>
              <span className="flex items-center gap-1.5 rounded-full bg-[rgba(255,222,186,0.05)] px-2.5 py-1 text-[10px] text-text-primary/40 font-medium border border-[#FFDEBA]/5 backdrop-blur-sm">
          ...
          <div className="flex h-full flex-col justify-center rounded-[36px] bg-[linear-gradient(135deg,rgba(55,50,55,0.15),rgba(30,26,30,0.15))] backdrop-blur-[20px] shadow-[inset_0_1px_0_rgba(255,222,186,0.05),_0_20px_40px_rgba(0,0,0,0.4)] p-8">
            <div className="flex items-center justify-between border-b border-[#FFDEBA]/10 pb-5">
              <div className="flex items-center gap-4">
                ...
                <div className="flex flex-col cursor-default select-none">
                  <span className="text-[15px] font-bold text-text-primary drop-shadow-sm">Hass Avocados (2-pack)</span>
                  <div className="flex items-center gap-2 text-[12px] text-text-primary/50 mt-0.5">
            ...
            <div className="flex items-center justify-between pt-5">
              <div className="flex items-center gap-4">
                ...
                <div className="flex flex-col cursor-default select-none">
                  <span className="text-[15px] font-bold text-text-primary drop-shadow-sm">Jacobs Monarch 200g</span>
                  <div className="flex items-center gap-2 text-[12px] text-text-primary/50 mt-0.5">
