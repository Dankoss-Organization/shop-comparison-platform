...
export default function FavoritesPage() {
  ...
  const LockedView = () => (
    <div className="flex min-h-[60vh] w-full flex-col items-center justify-center gap-10 rounded-[48px] border border-[#ffffff03] bg-gradient-to-b from-[#ffffff02] to-[#ffffff05] backdrop-blur-xl px-10 py-24 text-center shadow-[inset_0_1px_0_rgba(255,222,186,0.02)]">
      <div className="relative flex h-32 w-32 items-center justify-center">
        ...
        <div className="relative flex h-28 w-28 items-center justify-center rounded-full bg-[#3F363F]/30 border border-[#EC5800]/10 shadow-[0_20px_40px_rgba(0,0,0,0.1)]">
      ...
      <div className="flex flex-col gap-4 max-w-[420px]">
        <h2 className="text-3xl font-light tracking-wide text-[#FFDEBA]">Sign in to view favorites</h2>
        <p className="text-[16px] text-[#FFDEBA]/50 leading-relaxed font-light">
      ...
      <div className="flex flex-col sm:flex-row items-center gap-4 mt-4">
        ...
        <button
          onClick={() => router.push("/")}
          className="flex h-[48px] min-w-[180px] items-center justify-center rounded-full border border-[#ffffff12] bg-[rgba(45,40,45,0.2)] text-[15px] font-medium text-[#FFDEBA]/70 backdrop-blur-md transition-all hover:border-[#EC5800]/40 hover:text-[#FFDEBA] active:scale-95 hover:bg-[rgba(45,40,45,0.4)]"
        >
          Browse Catalog
        </button>
      </div>
  ...
  const EmptyView = () => (
    <div className="flex min-h-[60vh] w-full flex-col items-center justify-center gap-8 rounded-[48px] border border-[#ffffff03] bg-gradient-to-b from-[#ffffff02] to-[#ffffff05] backdrop-blur-xl px-10 py-24 text-center shadow-[inset_0_1px_0_rgba(255,222,186,0.02)]">
      <div className="relative flex h-28 w-28 items-center justify-center rounded-full bg-[#3F363F]/30 border border-[#ffffff05] shadow-[0_20px_40px_rgba(0,0,0,0.1)]">
      ...
      <div className="flex flex-col gap-3 max-w-[400px]">
        <h2 className="text-3xl font-light tracking-wide text-[#FFDEBA]">Your wishlist is empty</h2>
        <p className="text-[16px] text-[#FFDEBA]/50 leading-relaxed font-light">
  ...
  return (
    <main className="min-h-screen bg-[#2D282D] font-sans text-white">
      ...
      <div className="mx-auto max-w-[1440px] px-4 py-10 md:px-8 xl:px-[40px] min-h-[70vh]">
        <button
          onClick={() => router.push("/")}
          className="group mb-10 flex items-center gap-2 text-sm font-medium text-[#FFDEBA]/50 transition-colors hover:text-[#EC5800]"
        >
        ...
        <div className="mb-10 flex items-end justify-between border-b border-[#ffffff08] pb-6">
          <div>
            <h1 className="text-[2.5rem] font-black tracking-[0.05em] text-[#FFDEBA] uppercase leading-none">
              Favorites
            </h1>
            <p className="mt-3 text-[15px] text-[#FFDEBA]/50 font-light">
              {!isMounted
                ? "Loading…"
                : !isAuthenticated
