                  ...
                  <ChainIcon className={favoriteAuthHint?.type === "success" ? "shadow-[0_0_18px_rgb(var(--brand-orange)_/_0.35)]" : ""}>
                    <div className="relative flex items-center justify-center transition-opacity hover:opacity-80">
                      ...
                      {isMounted && favoriteCount > 0 && (
                        <span 
                          key={favoriteCount}
                          className="absolute -top-[15px] -right-[15px] flex h-[18px] min-w-[18px] items-center justify-center rounded-full border-[2px] border-bg-surface bg-brand-orange px-[4px] text-[9px] font-black leading-none text-white animate-in zoom-in duration-300"
                        >
                          {favoriteCount}
                        </span>
                      )}
                  ...
                  <ChainIcon>
                    <div className="relative flex h-[20px] w-[20px] items-center justify-center">
                      ...
                      {isMounted && favoriteCount > 0 && (
                        <span 
                          key={favoriteCount}
                          className="absolute -top-[15px] -right-[15px] flex h-[18px] min-w-[18px] items-center justify-center rounded-full border-[2px] border-bg-surface bg-brand-orange px-[4px] text-[9px] font-black leading-none text-white transition-opacity duration-300 group-hover/fav:opacity-0"
                        >
                          {favoriteCount}
                        </span>
                      )}
