...
export default function Footer() {
  return (
    <footer className="bg-bg-darker px-6 pb-6 pt-10 text-text-primary lg:px-12">
      
      <div
        className="relative mx-auto mb-14 w-full overflow-hidden rounded-[45px] shadow-[0_0_15px_rgb(var(--brand-orange)_/_0.2)] px-6 py-8 md:px-10 lg:px-[60px] lg:pb-10 lg:pt-9 bg-gradient-to-b from-bg-deep to-bg-deepest">
        <div
        ...
        <div className="relative z-10">
          <h2 className="mb-7 text-center text-3xl font-semibold uppercase tracking-[0.3em] text-text-primary md:text-[32px]">
            Contact Us
          </h2>
          ...
          <form className="mx-auto flex max-w-[850px] flex-col gap-4">
            ...
            <textarea
              placeholder="Message"
              required
              className="h-[110px] w-full resize-none rounded-[16px] border-none px-5 py-3 text-base text-text-primary outline-none transition placeholder:text-text-primary/70 focus:ring-2 focus:ring-brand-orange/50"
              style={{
      ...
      <div className="mx-auto mb-12 grid max-w-[1400px] gap-10 lg:grid-cols-[1.6fr_1fr_1fr_1.1fr] lg:gap-[30px]">
        <div>
          <div className="mb-4 flex items-center leading-none">
            <span className="text-[42px] font-semibold text-text-primary md:text-[46px]">DANK</span>
        ...
        <div>
          <h3 className="mb-5 text-[28px] font-bold leading-[34px] tracking-[2px] text-brand-orange">
            Contacts
          </h3>
...
export function FooterInput({ type, placeholder }: { type: string; placeholder: string }) {
  return (
    <input
      ...
      required
      className="h-[40px] flex-1 rounded-[16px] border-none px-5 text-base text-text-primary outline-none transition placeholder:text-text-primary/70 focus:ring-2 focus:ring-brand-orange/50"
      style={{
        background: "rgb(var(--bg-main) / 0.4)",
        boxShadow: "2px 2px 1px rgb(var(--brand-orange))",
...
export function FooterLinkColumn({ title, links }: { title: string; links: { label: string; href: string }[] }) {
  return (
    <div>
      <h3 className="mb-5 text-[28px] font-bold leading-[34px] tracking-[2px] text-brand-orange">{title}</h3>
