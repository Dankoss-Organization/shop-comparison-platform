...
export function CartItemUI({ 
  ...
  return (
    <div className="flex gap-4 border-b border-text-main/5 dark:border-white/5 py-5 last:border-0">
      <div 
      ...
      <div className="flex flex-1 flex-col justify-between py-0.5">
        <div className="flex justify-between items-start">
          ...
          <button onClick={onRemove} className="text-text-muted/50 dark:text-text-primary/30 hover:text-brand-orange dark:hover:text-brand-orange transition-colors">
        ...
        <div className="flex items-center justify-between mt-2">
          ...
          <div className="flex items-center gap-1.5 rounded-full border border-text-main/10 dark:border-white/10 bg-black/5 dark:bg-black/20 p-1">
            <button onClick={onDecrease} className="flex h-7 w-7 items-center justify-center rounded-full bg-white dark:bg-bg-deep text-text-muted dark:text-text-primary/60 hover:text-text-main dark:hover:text-text-primary shadow-sm dark:shadow-none transition">-</button>
            <span className="w-6 text-center text-xs font-black text-text-main dark:text-text-primary">{item.cartQuantity}</span>
            <button onClick={onIncrease} className="flex h-7 w-7 items-center justify-center rounded-full bg-white dark:bg-bg-deep text-text-muted dark:text-text-primary/60 hover:text-text-main dark:hover:text-text-primary shadow-sm dark:shadow-none transition">+</button>
          </div>
        </div>
      </div>
    </div>
