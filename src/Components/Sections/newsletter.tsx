...
const badgeClassName =
  "absolute left-1/2 top-0 z-20 h-[60px] w-[60px] rounded-full bg-[linear-gradient(180deg,#EC5800_0%,#8c3412_100%)] p-[3px] shadow-[0_10px_20px_#5e1f0047] sm:h-[68px] sm:w-[68px]";
      ...
      >
        ...
        <div className="relative z-10 mx-auto flex max-w-[980px] flex-col items-center text-center">
          <motion.h2 
            ...
            className="mt-1 max-w-[760px] text-[1.45rem] font-black leading-[0.96] tracking-[-0.05em] text-[#FFDEBA] sm:text-[1.75rem] lg:text-[2.15rem]"
          >
          ...
          <motion.p 
            variants={itemVariants}
            className="mt-3 max-w-[860px] text-[0.78rem] leading-[1.3] text-[#FFDEBAD1] sm:text-[0.86rem] lg:whitespace-nowrap lg:text-[0.94rem]"
          >
          ...
          >
            ...
            <div className="mt-0.5 flex min-h-[34px] flex-col items-center justify-start">
              {error && (
                <p className="text-[0.82rem] text-[#ffb37a] sm:text-[0.88rem]">{error}</p>
              )}
              {submitted && (
