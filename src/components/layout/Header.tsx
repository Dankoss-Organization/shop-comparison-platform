    ...
    <header className="relative z-[90] w-full border-b border-[#1A181C] bg-[#2B262C] font-sans shadow-lg">
      <div className="relative flex w-full items-center justify-between px-4 py-[8px] md:px-8 xl:px-[40px]">
            ...
            >
              <div className="relative flex h-[24px] w-[24px] items-center justify-center text-[#FFDEBA] transition-colors duration-300 group-hover:text-white">
                ...
                <svg 
                  ...
                  className={`absolute w-[24px] h-[24px] transition-all duration-500 ease-[cubic-bezier(0.16,1,0.3,1)] ${
                    isCatalogOpen 
                ...
                <svg 
                  ...
                  fill="none" 
                  xmlns="http://www.w3.org/2000/svg"
                  className={`absolute w-[26px] h-[26px] transition-all duration-500 ease-[cubic-bezier(0.16,1,0.3,1)] ${
                    isCatalogOpen 
            ...
            <span className="relative z-10 flex items-center text-[35px] font-bold tracking-[0.1em] text-[#F6D7B0] transition-colors duration-500 group-hover/logo:text-white group-hover/logo:drop-shadow-[0_0_10px_rgba(236,88,0,0.3)]">
              ...
              <span className="relative mx-[2px] flex h-[35px] w-[35px] items-center justify-center">
                ...
                <svg 
                  ...
                  fill="none" 
                  xmlns="http://www.w3.org/2000/svg"
                  className="absolute w-[45px] h-[45px] top-[-5px] transition-transform duration-500 group-hover/logo:scale-105"
                >
                  <g filter="url(#filter0_d_486_1007)">
                    ...
                    <path 
                      d="M28.3079 0.392901C29.6442 0.510806 30.843 1.04562 31.7895 1.85674C28.9147 2.17225 26.5664 4.47872 26.3025 7.46968C26.1348 9.37278 26.847 11.1506 28.1018 12.4017C25.1429 11.7156 23.0644 8.93942 23.3387 5.827C23.5756 3.1405 25.4944 1.00689 27.9657 0.371545C28.0792 0.375349 28.1934 0.382807 28.3079 0.392901Z" 
                      fill="url(#paint1_linear_486_1007)"
                      className="origin-[26px_12px] transition-transform duration-500 ease-[cubic-bezier(0.34,1.56,0.64,1)] group-hover/logo:rotate-[15deg] group-hover/logo:scale-[1.25]"
                    />
                    
                    <path 
                      fillRule="evenodd" 
                      clipRule="evenodd" 
                      d="M13.0758 7.04105C15.0478 5.79515 17.7905 5.37507 20.562 6.10871C21.413 6.33399 22.2074 6.6531 22.9318 7.04589C23.151 8.93863 24.1637 10.6377 25.6739 11.7431C24.1462 11.6782 22.5807 11.4483 21.0112 11.0328C17.9562 10.2241 15.2594 8.82151 13.0758 7.04105Z" 
                      fill="url(#paint2_linear_486_1007)"
                      className="origin-[25px_11px] transition-transform duration-500 delay-75 ease-[cubic-bezier(0.34,1.56,0.64,1)] group-hover/logo:-rotate-[15deg] group-hover/logo:scale-[1.25]"
                    />
                    ...
                    <path 
                      ...
                      d="M13.0758 7.04105C15.0478 5.79515 17.7905 5.37507 20.562 6.10871C21.413 6.33399 22.2074 6.6531 22.9318 7.04589C23.151 8.93863 24.1637 10.6377 25.6739 11.7431C24.1462 11.6782 22.5807 11.4483 21.0112 11.0328C17.9562 10.2241 15.2594 8.82151 13.0758 7.04105Z" 
                      fill="url(#paint1_linear_486_1007)"
                      className="origin-[25px_12px] opacity-0 scale-50 rotate-[60deg] transition-all duration-500 delay-[120ms] ease-[cubic-bezier(0.34,1.56,0.64,1)] group-hover/logo:opacity-100 group-hover/logo:scale-[0.85] group-hover/logo:rotate-[25deg] group-hover/logo:-translate-y-[2px]"
                    />
                  </g>
                  <defs>
        ...
        <div className="flex flex-1 items-center justify-end">
          ...
          <div className="relative z-10 hidden items-center lg:flex group/search focus-within:w-[280px] xl:focus-within:w-[340px] transition-all duration-500 ease-out">
            <input
              type="text"
              placeholder="SEARCH"
              className="h-[42px] w-[250px] xl:w-[300px] rounded-full bg-[#3F363F] border border-transparent pl-[20px] pr-[50px] text-[14px] tracking-[0.1em] text-[#FFDEBA] shadow-md outline-none placeholder:text-[#FFDEBA]/40 transition-all duration-500 focus:border-[#EC5800]/50 focus:bg-[#2A252A] focus:shadow-[0_0_20px_rgba(236,88,0,0.2)] focus:w-full"
            />

            <div className="absolute right-[2px] top-1/2 z-20 -translate-y-1/2 pointer-events-none transition-transform duration-300 group-focus-within/search:scale-110">
              <ChainIcon>
          ...
          <div className="group relative ml-8 xl:ml-[50px] flex h-[42px] w-[100px] shrink-0 cursor-pointer items-center justify-between rounded-full bg-[#4D444D] pl-[6px] pr-0 shadow-inner border border-transparent transition-all duration-300 hover:border-[#EC5800]/30 hover:bg-[#3A323A] hover:shadow-[0_0_15px_rgba(236,88,0,0.2)] active:scale-95">
            <div className="flex h-[30px] w-[30px] shrink-0 items-center justify-center transition-transform duration-700 ease-out group-hover:rotate-[180deg] group-hover:scale-110">
              <Image src="/orange_logo.svg" alt="logo" width={28} height={28} className="object-contain" />
            </div>

            <div className="absolute right-[2px] top-[4px] z-20 flex h-[44px] w-[44px] shrink-0 items-center justify-center transition-all duration-500 ease-out group-hover:-translate-y-1 group-hover:scale-110">
              <Image
                src="/basket.svg"
                alt="basket"
                width={44}
                height={44}
                className="relative top-[6px] object-contain transition-transform duration-300 group-hover:-rotate-3"
              />
